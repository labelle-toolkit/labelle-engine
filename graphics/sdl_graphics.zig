...
//!
//! Re-exports labelle-gfx types for the SDL backend.

const labelle = @import("labelle");

// Core engine - use SDL backend
const SdlGfx = labelle.withBackend(labelle.SdlBackend);
pub const RetainedEngine = SdlGfx.RetainedEngine;
