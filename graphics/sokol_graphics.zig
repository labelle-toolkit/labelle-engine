...
//!
//! Re-exports labelle-gfx types for the sokol backend.

const labelle = @import("labelle");

// Core engine - use sokol backend
const SokolGfx = labelle.withBackend(labelle.SokolBackend);
pub const RetainedEngine = SokolGfx.RetainedEngine;
