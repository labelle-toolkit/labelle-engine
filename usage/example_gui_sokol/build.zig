// ============================================================================
// ImGui GUI Example with Sokol Backend
// ============================================================================
// Demonstrates ImGui GUI with Sokol graphics backend.
// Uses sokol graphics backend with imgui_sokol_adapter.
// ============================================================================
...
pub fn build(b: *std.Build) void {
    ...
    // Backend options - sokol graphics with imgui GUI
    const backend = b.option(Backend, "backend", "Graphics backend (default: sokol)") orelse .sokol;
