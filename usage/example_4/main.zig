...
const bouncer_comp = @import("components/bouncer.zig");
pub const Bouncer = bouncer_comp.Bouncer;
const ecs_demo_script = @import("scripts/ecs_demo.zig");
...
pub const Components = engine.ComponentRegistry(struct {
    ...
    pub const Bouncer = main_module.Bouncer;
});
