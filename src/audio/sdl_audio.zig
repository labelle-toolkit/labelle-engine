//! SDL Audio Backend
//!
//! No-op stub implementation. SDL_mixer is not currently exposed through
//! the SDL bindings used by labelle-engine.
...
/// Check if audio is available (always false for SDL)
