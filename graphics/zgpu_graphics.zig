//! ZGPU Graphics Backend
//!
//! Re-exports labelle-gfx types for the ZGPU backend.

const labelle = @import("labelle");

// Core engine - use ZGPU backend
const ZgpuGfx = labelle.withBackend(labelle.ZgpuBackend);
pub const RetainedEngine = ZgpuGfx.RetainedEngine;
